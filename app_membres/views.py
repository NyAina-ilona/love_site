...
def Entrer_image(request,image):
    if "images" in request.FILES:
        ...
        emplacement = os.path.join("static/images/profils/",new_name)
...
def ajout_additional(request):
    if request.method == "POST":
        ...
        upload_to = os.path.join('static', 'images', 'membres')
        ...
        for i in range(1, 7):
            ...
            if image_field in request.FILES:
                ...
                new_image_path = os.path.join('images/membres', new_filename)
