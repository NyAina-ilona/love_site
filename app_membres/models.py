...
class Profil(models.Model):
    ...
    images = models.ImageField(upload_to="static/images/profils/")
    ...
    def __str__(self):
        return f"Profil de {self.membre.pseudo}"
...
class AdditionalProfileInfo(models.Model):
    ...
    additional_image1 = models.ImageField("static/images/membres/", blank=True, null=True)
    additional_image2 = models.ImageField("static/images/membres/", blank=True, null=True)
    additional_image3 = models.ImageField("static/images/membres/", blank=True, null=True)
    additional_image4 = models.ImageField("static/images/membres/", blank=True, null=True)
    additional_image5 = models.ImageField("static/images/membres/", blank=True, null=True)
    additional_image6 = models.ImageField("static/images/membres/", blank=True, null=True)
